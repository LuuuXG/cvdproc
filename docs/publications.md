...
The code is now implemented in the [wmh_quantification](./pipelines/sMRI/wmh_quantification.md) pipeline. For WMH segmention, we used the LST-LPA method with FLAIR images. For shape features, the source code is in `wmh_shape_nipype.py`.