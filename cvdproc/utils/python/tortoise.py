...
class _DRBUDDIInputSpec(TORTOISEInputSpec):
    ...
    disable_initial_rigid = traits.Bool(
        True,
        usedefault=True,
        argstr='--DRBUDDI_disable_initial_rigid',
        desc='Disable the initial rigid + diffeomorphic + rigid sequence. '
            'If True, passes --DRBUDDI_disable_initial_rigid. Default: True',
    )
