...
class AutoAifSel:
    ...
    def load_data(self):
        ...
        self.ROI_data = nib.load(self.ROI_fn).get_fdata().astype(bool)
        self.brain_mask_data = nib.load(self.brain_mask_fn).get_fdata().astype(bool)
        self.conc_data = nib.load(self.conc_fn).get_fdata()
