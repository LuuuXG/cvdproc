...
from .wmh.wmh_seg_nipype import LSTSegmentation, WMHSynthSeg, PrepareTrueNetData, TrueNetEvaluate, TrueNetPostProcess
...
class WMHSegmentationPipeline:
    ...
    def create_workflow(self):
        ...
        if self.location_method is not None:
            if t1w_file != '' and 'Fazekas' in self.location_method:                
