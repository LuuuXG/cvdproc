...
key_outputs=(
  ...
  "$output_dir/sub-${subject_id}_ses-${session_id}_hemi-L_space-${space_entity}_label-LGN_desc-dilate5x_mask.nii.gz"
  "$output_dir/sub-${subject_id}_ses-${session_id}_hemi-R_space-${space_entity}_label-LGN_desc-dilate5x_mask.nii.gz"
...
# dilate 5 voxel in x axis
python "$PY_EXTEND" \
  --in_mask "$output_dir/sub-${subject_id}_ses-${session_id}_hemi-L_space-${space_entity}_label-LGN_mask.nii.gz" \
  --out_mask "$output_dir/sub-${subject_id}_ses-${session_id}_hemi-L_space-${space_entity}_label-LGN_desc-dilate5x_mask.nii.gz" \
...
python "$PY_EXTEND" \
  ...
  --out_mask "$output_dir/sub-${subject_id}_ses-${session_id}_hemi-R_space-${space_entity}_label-LGN_desc-dilate5x_mask.nii.gz" \
